...
def saveAsFile():
    ...
    if file == None:
        file = filedialog.asksaveasfilename(initialfile="Untitled.txt", filetypes=[("All files", "*.*"), ("Text Documents", "*.txt")])
...
def help():
    ...
    messagebox.showinfo("Notepad", "Acid Tile Investigator (ATI)")
